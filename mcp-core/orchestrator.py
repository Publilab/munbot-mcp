...
FIELD_QUESTIONS = {
    ...
    "bloque_cita": "Perfecto. Para agendar la cita, ¿en qué fecha y hora te gustaría reservar?",
    "nombre_cita": "Para poder asignar una cita con un funcionario, necesito que me proporciones tu nombre completo",
