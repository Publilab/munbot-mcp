...
def orchestrate(
    ...
    # --- DEPRECADO: Se prioriza el flujo RAG a través de llm_docs-mcp ---
    # El siguiente bloque utilizaba una búsqueda estática en JSONs locales.
    # Se comenta para asegurar que todas las consultas de conocimiento pasen
    # por el motor de búsqueda semántica en llm_docs-mcp.
